...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(f7d678ee)", "rgba(e8b23cee)"}, angle = 45 },
            inactive_border = "rgba(160d1faa)",
        },
...
hl.bind(mainMod .. "+ SHIFT + S", hl.dsp.exec_cmd("grim -g \"$(slurp -b 33292baa -c ff5c54ff -F 'JetBrains Mono' -d)\" \"${HOME}/Pictures/Screenshots/$(date --iso=ns|head -c 22).png\""))
hl.bind("SHIFT + PRINT", hl.dsp.exec_cmd("grim \"${HOME}/Pictures/Screenshots/$(date --iso=ns|head -c 22).png\""))
